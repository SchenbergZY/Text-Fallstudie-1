...
Die Elemente eines Korpus können nach unterschiedlichen Strategien mit jeweils spezifischen Kriterien ausgewählt werden. Für Datensammlungen insgesamt (und damit auch für Korpora als besonderen Typus der Datensammlung) hat {cite:p}`schoech2017` vier Strategien unterschieden:
